...
$(document).ready(function() {
    ...
    $('#dark_btn').on('click', function(){
        ...
        document.getElementById("light_btn").style.display = "block";
    });
    $('#light_btn').on('click', function(){
        $('body').removeClass('dark-layout');
        $('nav').removeClass('navbar-dark');
        $('nav').addClass('navbar-light');
        document.getElementById("dark_btn").style.display = "block";
...
/******** start uplaod and perview videio **************/
$(document).ready(function() {
...
$('#subcategory_id').on('change',function(e){
    ...
    $.get( base_url + '/ajax-subsubcats?subcategory_id='+ subcategory_id,function(data){
        ...
        $.each(data,function(index, subsubcatObj){
            $('#subsubcategory_id').append('<option value="'+subsubcatObj.id+'">'+subsubcatObj.title +'</option>');
        });
    });
});
...
if ($('input[name="kind"]:checked').val() == 1){
    $('.link').hide();
    $('.file').show();
} else if ($('input[name="kind"]:checked').val() == 0){
    $('.link').show();
    $('.file').hide();
}
