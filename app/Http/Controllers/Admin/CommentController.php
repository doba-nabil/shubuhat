...
class CommentController extends Controller
{
    ...
    {
        $this->middleware('permission:comment-list|comment-show|comment-delete', ['only' => ['index','show']]);
        $this->middleware('permission:comment-show', ['only' => ['show']]);
        $this->middleware('permission:comment-delete', ['only' => ['destroy' , 'delete_categories']]);
    }
    /**
