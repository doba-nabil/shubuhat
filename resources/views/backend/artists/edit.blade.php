            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">تعديل معلومات الفنان {{ $artist->name_ar }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('artists.update' , $artist->id) }}" enctype="multipart/form-data" id="myformedit">
                                @csrf
                                {{ method_field('PATCH') }}
                                <div class="form-row">
                                    <div class="col-md-12 col-12 mb-3">
                                        <label for="name_ar">الاسم بالعربية</label>
                                        <input type="text" name="name_ar" class="form-control" id="name_ar" placeholder="الاسم بالعربية" value="{{ $artist->name_ar }}" required>
                                        @error('name_ar')
                                    ...
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="text" name="name_en" id="name_en" class="form-control" placeholder="الاسم بالانجليزية" value="{{ $artist->name_en }}" required>
                                        @error('name_en')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <textarea id="details_ar" class="summernote" name="details_ar" required>{{ $artist->details_ar }}</textarea>
                                        @error('details_ar')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <textarea id="details_en" class="summernote" name="details_en" required>{{ $artist->details_ar }}</textarea>
                                        @error('details_en')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="phone" name="phone" class="form-control" id="phone" placeholder="الهاتف" value="{{ $artist->phone }}" required>
                                        @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email" placeholder="البريد الالكتروني" value="{{ $artist->email }}" required>
                                        @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="url" name="social" class="form-control" id="social" placeholder="ايميل التواصل" value="{{ $artist->social }}" required>
                                        @error('social')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="url" name="website" class="form-control" id="website" placeholder="الموقع الالكتروني للفنان" value="{{ $artist->website }}" required>
                                        @error('website')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <select  name="category_id" class="select2 form-control" id="category_id">
                                                @foreach($categories as $category)
                                                    <option
                                                            @if($category->id == $artist->subcategory->parentCategory->id) selected @endif
                                                            value="{{ $category->id }}">{{ $category->title_ar }} / {{ $category->title_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('category_id')
                                        ...
                                        <div class="form-group">
                                            <select name="subcategory_id" id="subcategory_id" class="select2 form-control">
                                                @foreach($subcategories as $subcategory)
                                                    <option
                                                            @if($subcategory->id == $artist->subcategory->id) selected @endif
                                                    value="{{ $subcategory->id }}">{{ $subcategory->title_ar }} / {{ $subcategory->title_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            <select id="country_id" name="country_id" id="" class="select2 form-control">
                                                <option disabled selected hidden>اختر الدولة</option>
                                                @foreach($countries as $country)
                                                    <option
                                                            @if($country->id == $artist->country->id) selected @endif
                                                            value="{{ $country->id }}">{{ $country->name_ar }} / {{ $country->name_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('country_id')
                                        ...
                                        <div class="form-group">
                                            <select id="city_id" name="city_id" class="select2 form-control">
                                                @foreach($cities as $city)
                                                    <option
                                                            @if($city->id == $artist->city->id) selected @endif
                                    ...
                                    <div class="col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            <select name="gender" id="" class="select2 form-control">
                                                ...
                                                <option @if($artist->gender == 'male') selected @endif value="male">Male</option>
                                                <option @if($artist->gender == 'female') selected @endif value="Female">Female</option>
                                            </select>
                                        </div>
                                        @error('gender')
                                        <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-image">
                                        ...
                                        <div class="text-center">
                                            <img id="blah" src="{{ asset('pictures/artists/' . $artist->image) }}" alt="your image" />
                                        </div>
                                        <br>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="file-input">اضغط لاختار الفيديو</label>
                                            </div>
                                            @error('video')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="text-center">
                                            <video id="video" width="200" height="200" controls>
                                                <source src="{{ asset('pictures/artists/' . $artist->video ) }}">
                                            </video>
                                        </div>
                                        <br>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="multi-images">
                                                    <span class="btn fileinput-button">
                                                        ...
                                                        <input type="file" name="images[]" id="files" multiple accept="image/jpeg, image/png, image/gif,"><br />
                                                    </span>
                                                <br>
                                                <br>
                                    ...
                                    <div class="col-md-12">
                                        @foreach($artist->images as $image)
                                            <div class="image_class{{ $image->id }}" style="width:102px;display: inline-block">
                                                <img width="100" height="100" src="{{ asset('pictures/artists/' . $image->image) }}">
                                                <a  style="width: 100px;border-radius: 0;text-align: center" title="" onclick="return false;" object_id="{{ $image->id }}"
                                                    delete_url="/delete_artist_image/" class="btn btn-danger edit-btn-table delete_event_image" href="#">
                                                    حذف
                                                </a>
                                            </div>
                                        @endforeach
                                                            ...
                                                            <fieldset>
                                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                                    <input name="types[]" type="checkbox"
                                                                           @foreach($artist->types as $typee)
                                                                               @if($type->id == $typee->event_type_id)
                                                                                   checked
                                                                               @endif
                                                                           @endforeach
                                                                           value="{{ $type->id }}">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <li class="d-inline-block mr-5">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input @if($artist->active == 1) checked @endif name="active" type="checkbox" checked value="1">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <li class="d-inline-block mr-5">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input @if($artist->chosen == 1) checked @endif  name="chosen" type="checkbox" checked value="1">
                                                    <span class="vs-checkbox vs-checkbox-lg">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
