                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_comments/">
                                حذف الكل</a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table data-thumb-view">
                    ...
                    @foreach($comments as $comment)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-name">{{ $comment->user->name }}</td>
                            <td>
                                {{ $comment->question->mini_question }}
                            </td>
                            <td>
                                {{ $comment->question->id }}
                            </td>
                            ...
                            <td class="product-action">
                                <a title="" onclick="return false;" object_id="{{ $comment->id }}"
                                   delete_url="/comments/" class="edit-btn-table remove-alert" href="#">
