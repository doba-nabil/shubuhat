            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">اضافة شبهة جديدة</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('questions.store') }}" enctype="multipart/form-data" id="myform">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-12 col-12 mb-3">
                                        <label for="question">نص السؤال كاملا</label>
                                        <textarea rows="10" name="question" class="form-control" id="question" placeholder="نص السؤال كاملا" required>{{ old('question') }}</textarea>
                                        @error('question')
                                    ...
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <input type="text" name="mini_question" class="form-control" id="mini_question" placeholder="السؤال بإختصار" value="{{ old('mini_question') }}" required>
                                        @error('mini_question')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
