                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('books.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                            <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_books/">
                            حذف الكل</a>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach($books as $book)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('books.edit' , $book->slug) }}"><i class="feather icon-edit"></i></a></span>
                                <a title="" onclick="return false;" object_id="{{ $book->id }}"
                                   delete_url="/books/" class="edit-btn-table remove-alert" href="#">
