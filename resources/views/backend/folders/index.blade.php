                        ...
                        <div class="btn-dropdown mr-1 mb-1">
                            <div class="btn-group dropdown actions-dropodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('folders.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                                    <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_folders/">
                                        حذف الكل</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table data-thumb-view">
                            ...
                            <tr class="delete-all-cats">
                                ...
                                <td class="product-img"><img src="{{ asset('pictures/folders/' . $folder->mainImage->image) }}" alt="{{ $folder->title }}">
                                </td>
                                <td class="product-name">{{ $folder->title }}</td>
                                <td class="product-name">{{ $folder->startDate }}</td>
                                <td class="product-name">{{ $folder->endDate }}</td>
                                ...
                                <td class="product-action">
                                    <span class="action-edit"><a href="{{ route('folders.edit' , $folder->slug) }}"><i class="feather icon-edit"></i></a></span>
                                    <a title="" onclick="return false;" object_id="{{ $folder->id }}"
                                       delete_url="/folders/" class="edit-btn-table remove-alert" href="#">
