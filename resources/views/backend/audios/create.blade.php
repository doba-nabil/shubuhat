            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">اضافة ملف صوتي جديد</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('audios.store') }}" enctype="multipart/form-data" id="myform">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 col-12 mb-3">
                                        <label for="body">العنوان الفرعي</label>
                                        <input rows="10" name="body" class="form-control" placeholder="عنوان فرعي" value="{{ old('body') }}" required>
                                        @error('body')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <label for="linkRadio"> رابط SoundCloud</label><br>
                                    ...
                                    <div class="col-md-12 col-12 mb-3 link">
                                        ...
                                        <input type="text" name="link" class="form-control" id="link" placeholder=" رابط الــ SoundCloud" value="{{ old('link')}}">
                                        @error('link')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 col-12 mb-3 file">
                                        <label for="file-input">الفيديو </label>
