                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('audios.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                            <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_audios/">
                            حذف الكل</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table data-thumb-view">
                    ...
                    @foreach($audios as $audio)
                        <div class="modal fade" id="exampleModalCenter{{ $audio->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle{{ $audio->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle{{ $audio->id }}">{{ $audio->title }}</h5>
                        ...
                        <tr class="delete-all-cats">
                            ...
                            <td>
                                <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter{{ $audio->id }}">
                                    <i class="fa fa-headphones"></i>
                                </a>
                            </td>
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('audios.edit' , $audio->slug) }}"><i class="feather icon-edit"></i></a></span>
                                <a title="" onclick="return false;" object_id="{{ $audio->id }}"
                                   delete_url="/audios/" class="edit-btn-table remove-alert" href="#">
