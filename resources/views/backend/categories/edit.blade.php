            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">تعديل التصنيف {{ $category->title_ar }}</h4>
                    </div>
                            ...
                            <form method="post" action="{{ route('categories.update' , $category->id) }}" enctype="multipart/form-data" id="myform">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <textarea rows="10" name="body" class="form-control" placeholder="نبذة عن التصنيف" required>{{ $category->body }}</textarea>
                                        @error('body_ar')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
