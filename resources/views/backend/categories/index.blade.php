                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('categories.create') }}"><i class="fa fa-plus"></i>اضافة
                                جديد</a>
                            <a class="dropdown-item delete-all" onclick="return false;"
                               delete_url="/delete_categories/">
                                حذف الكل</a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table data-thumb-view">
                    ...
                    @foreach($categories as $category)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-subname">{{ $category->subtitle }}</td>
                            <td>
                                {{ $category->getActive() }}
                            </td>
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('categories.edit' , $category->slug) }}"><i
