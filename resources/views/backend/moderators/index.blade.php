                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('moderators.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($users as $user)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('moderators.edit' , $user->id) }}"><i
                                                class="feather icon-edit"></i></a></span>
                                @if($user->id != 1)
                                <a title="" onclick="return false;" object_id="{{ $user->id }}"
                                   delete_url="/moderators/" class="edit-btn-table remove-alert" href="#">
