                        ...
                        <div class="btn-dropdown mr-1 mb-1">
                            <div class="btn-group dropdown actions-dropodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('subcategories.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                                    <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_subcategories/">
                                        حذف الكل</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table data-thumb-view">
                            ...
                            <tr class="delete-all-cats">
                                ...
                                <td class="product-category">{{ $category->parentCategory->title ?? '' }}</td>
                                <td>
                                    {{ $category->getActive() }}
                                </td>
                                <td class="product-action">
                                    <span class="action-edit"><a href="{{ route('subcategories.edit' , $category->slug) }}"><i class="feather icon-edit"></i></a></span>
                                    <a title="" onclick="return false;" object_id="{{ $category->id }}"
                                       delete_url="/categories/" class="edit-btn-table remove-alert" href="#">
