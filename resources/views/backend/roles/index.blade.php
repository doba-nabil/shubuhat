                    ...
                    @foreach($roles as $role)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('roles.show' , $role->id) }}"><i
                                                class="fa fa-eye"></i></a></span>
                                @if($role->id != 2)
                                <span class="action-edit"><a href="{{ route('roles.edit' , $role->id) }}"><i
                                                class="feather icon-edit"></i></a></span>
                                
                                <a title="" onclick="return false;" object_id="{{ $role->id }}"
                                   delete_url="/roles/" class="edit-btn-table remove-alert" href="#">
