            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('articles.store') }}" enctype="multipart/form-data" id="myform">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div  style="direction: ltr" class="col-md-12 col-12 mb-3">
                                        ...
                                        <textarea rows="10" name="body" class="form-control summernote" placeholder="نص المقال" required>{{ old('body') }}</textarea>
                                        @error('body')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
