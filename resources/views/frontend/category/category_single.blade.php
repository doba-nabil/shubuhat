                ...
                <div class="allshobohat">
                    <div class="title">
                        @if(isset($category->parentCategory->slug))
                            <a class="btn catbtn" href="{{ route('category.show' , $category->parentCategory->slug) }}">
                                عودة للتصنيف الأب
                            </a>
                        @else
                            <button type="button" class="catbtn btn" disabled>
                                تصنيف رئيسي
                            </button>
                        @endif
                        <h4 class="titleshop">
                    ...
                    <div class="tab-content">
                        <div id="vdio" class=" tab-pane active">
                            ...
                            @else
                                <div class="alert alert-warning">
                                    <h3>
                                        لا يوجد فيديوهات في ذلك التصنيف....
                                    </h3>
                                </div>
                            @endif
                        </div>
